...
import 'package:permisapp/controllers/school/school_add_candidat1_controller.dart';
import '../../Components/appVars.dart';

class SchoolAddCandidat1 extends StatelessWidget {
  const SchoolAddCandidat1({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            InkWell(
                ...
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    content: SingleChildScrollView(
                      child: ListBody(
                        children: [
                          GetBuilder<SchoolAddCandidat1Controller>(
                            init:SchoolAddCandidat1Controller(),
              ...
              child:GetBuilder<SchoolAddCandidat1Controller>(
                init: SchoolAddCandidat1Controller(),
                  ...
                  GetBuilder<SchoolAddCandidat1Controller>(
                    builder:(controller)=> TextFormField(
                      ...
                      onTap: () async {
                        ...
                        date = await showDatePicker(context: context, initialDate: DateTime.now().subtract(const Duration(days: 6570)),
                            firstDate: DateTime(1900),
                            lastDate: DateTime(2100)
                        );
                        var formate2 = "";
                        formate2 = "${date?.day}-${date?.month}-${date?.year}";
                        controller.dateController.text = date?.day == null ? "${DateFormat("yyyy-MM-dd").parse(DateTime.now().subtract(const Duration(days: 6570)).toString()).year}-${DateFormat("yyyy-MM-dd").parse(DateTime.now().subtract(const Duration(days: 6570)).toString()).month}-${DateFormat("yyyy-MM-dd").parse(DateTime.now().subtract(const Duration(days: 6570)).toString()).day}" : formate2;
                      },
                    ),
                  ),
                  10.verticalSpace,
