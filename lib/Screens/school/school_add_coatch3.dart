...
import '../../controllers/school/school_add_coach3_controller.dart';

class SchoolAddCoatch3 extends StatelessWidget {
  const SchoolAddCoatch3({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<SchoolAddCoach3Controller>(
        init: SchoolAddCoach3Controller(),
              ...
              children: [
                ...
                Center(
                  child: InkWell(
                      ...
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: SingleChildScrollView(
                            child: ListBody(
                              children: [
                                GetBuilder<SchoolAddCoach3Controller>(
                                  init: SchoolAddCoach3Controller(),
                    ...
                    child: GetBuilder<SchoolAddCoach3Controller>(
                      init: SchoolAddCoach3Controller(),
                  ...
                  child: GetBuilder<SchoolAddCoach3Controller>(
                    builder:(controller) => TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText: StringTranslateExtension('cardnumbermoniteur').tr(),
      ...
      floatingActionButton: SizedBox(
        ...
        child:GetBuilder<SchoolAddCoach3Controller>(
          ...
          builder:(controller) => FloatingActionButton.extended(
            ...
            onPressed: () async {
              controller.schoolAddCoatch3(context);
            },
            label: Text(
              "continue",
