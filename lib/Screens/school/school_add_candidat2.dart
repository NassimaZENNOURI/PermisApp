...
import '../../controllers/school/school_add_candidat2_controller.dart';

class SchoolAddCandidat2 extends StatelessWidget {
  const SchoolAddCandidat2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<SchoolAddCandidat2Controller>(
        init: SchoolAddCandidat2Controller(),
              ...
              children: [
                ...
                Center(
                  child: InkWell(
                      ...
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: SingleChildScrollView(
                            child: ListBody(
                              children: [
                                GetBuilder<SchoolAddCandidat2Controller>(
                                  init:SchoolAddCandidat2Controller(),
                    ...
                    child: GetBuilder<SchoolAddCandidat2Controller>(
                      init: SchoolAddCandidat2Controller(),
      ...
      floatingActionButton: SizedBox(
        ...
        child:GetBuilder<SchoolAddCandidat2Controller>(
          ...
          builder:(controller)=> FloatingActionButton.extended(
            ...
            onPressed: () async {
              controller.schoolAddCandidat2(context);
            },
            label: Text(
              "continue",
