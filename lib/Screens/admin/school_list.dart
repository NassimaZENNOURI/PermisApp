...
import '../../controllers/admin/school_list_controller.dart';
import 'add_school.dart';
import 'detail_school.dart';
...
class SchoolList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ListSchoolController>(
        init: ListSchoolController(),
        builder: (controller) {
          return controller.isLoading.value ? Loading(): Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                5.verticalSpace,
                GetBuilder<ListSchoolController>(
                  init: ListSchoolController(),
                  builder: (controller) => TextField(
                    key: const GlobalObjectKey('school55'),
                ...
                15.verticalSpace,
                Expanded(
                  child: GetBuilder<ListSchoolController>(
                  builder: (controller) => GridView.builder(
                    ...
                    itemBuilder: (context,index){
                      final school = controller.search()[index];
                      return GestureDetector(
                        onTap: (){
                          Get.to(const DetailSchool() , arguments: [school]);
                        },
                        child: Padding(
