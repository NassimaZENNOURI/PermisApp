...
import 'package:permisapp/Screens/school/school_add_candidat2.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'dart:io';
import '../../apiFunctions/Functions.dart';

class SchoolAddCandidat1Controller extends GetxController{
  ...
  validate1() async {
    if (emailController.text.trim().isEmpty) {
      Get.snackbar(tr('error'), tr('emailrequired'),
