...
class SchoolAddCoach2Controller extends GetxController{

  var selectedImagePath1 =File('');
  var selectedImagePath2 = File('');
  String? base64Image1;
  String? base64Image2;
  String? verso = '';
  String? recto = '';
  ...
  schoolAddCoatch2(BuildContext context) async {
